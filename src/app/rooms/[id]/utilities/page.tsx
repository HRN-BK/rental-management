...
import { ArrowLeft, Plus, Home, AlertCircle, Building2 } from 'lucide-react'
import type { Room, Property, Utility, UtilityBill } from '@/types/database'
...
const mockRoom: Room & { property: Property } = {
  ...
  status: 'occupied',
  description: 'Phòng đầy đủ nội thất, có ban công',
...
const mockUtilities: Utility[] = [
  {
    id: '1',
    property_id: '1', // Actually room_id in this context
    name: 'Điện phòng P101',
    type: 'electricity',
    provider: 'Công ty Điện Lực Gia Định',
    customer_code: 'P101-EVN',
    monthly_due_date: 2,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: '2',
    property_id: '1',
    name: 'Nước phòng P101',
    type: 'water',
    provider: 'Công ty Cấp Nước Gia Định',
    customer_code: 'P101-WATER',
    monthly_due_date: 25,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
...
export default function RoomUtilitiesPage() {
  const params = useParams()
  const [room, setRoom] = useState<(Room & { property: Property }) | null>(null)
    ...
    try {
      ...
      if (utilityFormModal.utility) {
        ...
        const newUtility: Utility = {
          ...
          property_id: params.id as string, // Actually room_id
          name: data.name!,
          type: data.type!,
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                ...
                <p>
                  <strong>Diện tích:</strong> {room.area_sqm}m²
                </p>
                <p>
                ...
                <p>
                  ...
                  {room.deposit_amount?.toLocaleString('vi-VN')} VNĐ
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <p>
                  <strong>Tên nhà:</strong> {room.property.name}
                </p>
                <p>
                  <strong>Địa chỉ:</strong> {room.property.address}
                </p>
        ...
        {utilities.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Bắt đầu bằng cách thêm chi phí đầu tiên cho phòng này.
            </p>
            <Button
              onClick={handleAddUtility}
              className="bg-blue-500 hover:bg-blue-600"
      ...
      <UtilityFormModal
        ...
        propertyId={params.id as string} // Actually room_id in this context
      />
