  ...
  try {
    ...
    if (propError) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: 'Lỗi tạo properties: ' + propError.message,
          details: propError,
        },
        { status: 500 }
      )
    }
    results.properties = insertedProperties.length
    ...
    if (tenantError) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: 'Lỗi tạo tenants: ' + tenantError.message,
          details: tenantError,
        },
        { status: 500 }
      )
    }
    results.tenants = insertedTenants.length
    ...
    if (roomError) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: 'Lỗi tạo rooms: ' + roomError.message,
          details: roomError,
        },
        { status: 500 }
      )
    }
    results.rooms = insertedRooms.length
    ...
    if (contractError) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: 'Lỗi tạo contracts: ' + contractError.message,
          details: contractError,
        },
        { status: 500 }
      )
    }
    results.contracts = insertedContracts.length
    ...
    if (invoiceError) {
      ...
      return NextResponse.json(
        {
          success: false,
          message: 'Lỗi tạo invoices: ' + invoiceError.message,
          details: invoiceError,
        },
        { status: 500 }
      )
    }
    results.invoices = insertedInvoices.length
    ...
    return NextResponse.json({
      success: true,
      message: `Đã tạo thành công: ${results.properties} properties, ${results.tenants} tenants, ${results.rooms} rooms, ${results.contracts} contracts, ${results.invoices} invoices`,
      details: results,
    })
  } catch (error) {
